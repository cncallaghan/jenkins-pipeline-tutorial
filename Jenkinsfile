...
pipeline {
    ...
    steps {
        ...
        sh "aws ecs update-service --cluster arn:aws:ecs:us-east-1:894427396428:cluster/cnc-cluster2 --service cnc-service-api-test --task-definition arn:aws:ecs:us-east-1:894427396428:task-definition/cnc-task-definition-cli-test:$revision_number --region us-east-1"
    }
}
    }
}
